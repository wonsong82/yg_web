...
$order_detail_message = (!isset($messages['wcst_mail_message']) || $messages['wcst_mail_message'] == "") ? $default_message:$messages['wcst_mail_message'];
...
if($order_meta_additional_shippings)
{
	...
	{
		$order_detail_message_additional .= (!isset($messages['wcst_mail_message_additional_shippings']) || $messages['wcst_mail_message_additional_shippings'] == "") ? $default_message_additional:$messages['wcst_order_details_page_additional_shippings'];
